...
function VectorPointProjectionOnLineSegment(v1, v2, v)
	...
	pointSegment = Geometry.Vector3(pointSegment.x,0,pointSegment.y)
	pointLine = Geometry.Vector3(pointLine.x,0,pointLine.y)
...
function VPrediction:__init()
	...
	self.hitboxes = {
		['Braum'] = 80, ['RecItemsCLASSIC'] = 65, ['TeemoMushroom'] = 50.0, ['TestCubeRender'] = 65, ['Xerath'] = 65, ['Kassadin'] = 65, 
		['Rengar'] = 65, ['Thresh'] = 55.0, ['RecItemsTUTORIAL'] = 65, ['Ziggs'] = 55.0, ['ZyraPassive'] = 20.0, ['ZyraThornPlant'] = 20.0, 
		['KogMaw'] = 65, ['HeimerTBlue'] = 35.0, ['EliseSpider'] = 65, ['Skarner'] = 80.0, ['ChaosNexus'] = 65, ['Katarina'] = 65, 
		['Riven'] = 65, ['SightWard'] = 1, ['HeimerTYellow'] = 35.0, ['Ashe'] = 65, ['VisionWard'] = 1, ['TT_NGolem2'] = 80.0, ['ThreshLantern'] = 65, 
		['RecItemsCLASSICMap10'] = 65, ['RecItemsODIN'] = 65, ['TT_Spiderboss'] = 200.0, ['RecItemsARAM'] = 65, 
		['OrderNexus'] = 65, ['Soraka'] = 65, ['Jinx'] = 65, ['TestCubeRenderwCollision'] = 65, ['Red_Minion_Wizard'] = 48.0, 
		['JarvanIV'] = 65, ['Blue_Minion_Wizard'] = 48.0, ['TT_ChaosTurret2'] = 88.4, ['TT_ChaosTurret3'] = 88.4, 
		['TT_ChaosTurret1'] = 88.4, ['ChaosTurretGiant'] = 88.4, ['Dragon'] = 100.0, ['LuluSnowman'] = 50.0, 
		['Worm'] = 100.0, ['ChaosTurretWorm'] = 88.4, ['TT_ChaosInhibitor'] = 65, ['ChaosTurretNormal'] = 88.4, 
		['AncientGolem'] = 100.0, ['ZyraGraspingPlant'] = 20.0, ['HA_AP_OrderTurret3'] = 88.4, ['HA_AP_OrderTurret2'] = 88.4, 
		['Tryndamere'] = 65, ['OrderTurretNormal2'] = 88.4, ['Singed'] = 65, ['OrderInhibitor'] = 65, ['Diana'] = 65, 
		['HA_FB_HealthRelic'] = 65, ['TT_OrderInhibitor'] = 65, ['GreatWraith'] = 80.0, ['Yasuo'] = 65, 
		['OrderTurretDragon'] = 88.4, ['OrderTurretNormal'] = 88.4, ['LizardElder'] = 65.0, ['HA_AP_ChaosTurret'] = 88.4, 
		['Ahri'] = 65, ['Lulu'] = 65, ['ChaosInhibitor'] = 65, ['HA_AP_ChaosTurret3'] = 88.4, ['HA_AP_ChaosTurret2'] = 88.4, 
		['ChaosTurretWorm2'] = 88.4, ['TT_OrderTurret1'] = 88.4, ['TT_OrderTurret2'] = 88.4, ['TT_OrderTurret3'] = 88.4, ['LuluFaerie'] = 65,
		['HA_AP_OrderTurret'] = 88.4, ['OrderTurretAngel'] = 88.4, ['YellowTrinketUpgrade'] = 1, ['MasterYi'] = 65, ['Lissandra'] = 65,
		['ARAMOrderTurretNexus'] = 88.4, ['Draven'] = 65, ['FiddleSticks'] = 65, ['SmallGolem'] = 80.0, ['ARAMOrderTurretFront'] = 88.4,
		['ChaosTurretTutorial'] = 88.4, ['NasusUlt'] = 80.0, ['Maokai'] = 80.0, ['Wraith'] = 50.0, ['Wolf'] = 50.0, ['Sivir'] = 65, ['Corki'] = 65, 
		['Janna'] = 65, ['Nasus'] = 80.0, ['Golem'] = 80.0, ['ARAMChaosTurretFront'] = 88.4, ['ARAMOrderTurretInhib'] = 88.4, ['LeeSin'] = 65, 
		['HA_AP_ChaosTurretTutorial'] = 88.4, ['GiantWolf'] = 65.0, ['HA_AP_OrderTurretTutorial'] = 88.4, 
		['YoungLizard'] = 50.0, ['Jax'] = 65, ['LesserWraith'] = 50.0, ['Blitzcrank'] = 80.0, ['brush_D_SR'] = 65, 
		['brush_E_SR'] = 65, ['brush_F_SR'] = 65, ['brush_C_SR'] = 65, ['brush_A_SR'] = 65, ['brush_B_SR'] = 65, 
		['ARAMChaosTurretInhib'] = 88.4, ['Shen'] = 65, ['Nocturne'] = 65, ['Sona'] = 65, ['ARAMChaosTurretNexus'] = 88.4, 
		['YellowTrinket'] = 1, ['OrderTurretTutorial'] = 88.4, ['Caitlyn'] = 65, ['Trundle'] = 65,
		['Malphite'] = 80.0, ['Mordekaiser'] = 80.0, ['ZyraSeed'] = 65, ['Vi'] = 50, ['Tutorial_Red_Minion_Wizard'] = 48.0,
		['Renekton'] = 80.0, ['Anivia'] = 65, ['Fizz'] = 65, ['Heimerdinger'] = 55.0, ['Evelynn'] = 65, ['Rumble'] = 80.0, 
		['Leblanc'] = 65, ['Darius'] = 80.0, ['OlafAxe'] = 50.0, ['Viktor'] = 65, ['XinZhao'] = 65, ['Orianna'] = 65, 
		['Vladimir'] = 65, ['Nidalee'] = 65, ['Tutorial_Red_Minion_Basic'] = 48.0, ['ZedShadow'] = 65, ['Syndra'] = 65, 
		['Zac'] = 80.0, ['Olaf'] = 65, ['Veigar'] = 55.0, ['Twitch'] = 65, ['Alistar'] = 80.0, ['Akali'] = 65, 
		['Urgot'] = 80.0, ['Leona'] = 65, ['Talon'] = 65, ['Karma'] = 65, ['Jayce'] = 65, ['Galio'] = 80.0, ['Shaco'] = 65,
		['Taric'] = 65, ['TwistedFate'] = 65, ['Varus'] = 65, ['Garen'] = 65, ['Swain'] = 65, ['Vayne'] = 65, ['Fiora'] = 65,
		['Quinn'] = 65, ['Kayle'] = 65, ['Blue_Minion_Basic'] = 48.0, ['Brand'] = 65, ['Teemo'] = 55.0, ['Amumu'] = 55.0, 
		['Annie'] = 55.0, ['Odin_Blue_Minion_caster'] = 48.0, ['Elise'] = 65, ['Nami'] = 65, ['Poppy'] = 55.0, ['AniviaEgg'] = 65, 
		['Tristana'] = 55.0, ['Graves'] = 65, ['Morgana'] = 65, ['Gragas'] = 80.0, ['MissFortune'] = 65, ['Warwick'] = 65, 
		['Cassiopeia'] = 65, ['Tutorial_Blue_Minion_Wizard'] = 48.0, ['DrMundo'] = 80.0, ['Volibear'] = 80.0, ['Irelia'] = 65, 
		['Odin_Red_Minion_Caster'] = 48.0, ['Lucian'] = 65, ['Yorick'] = 80.0, ['RammusPB'] = 65, ['Red_Minion_Basic'] = 48.0, 
		['Udyr'] = 65, ['MonkeyKing'] = 65, ['Tutorial_Blue_Minion_Basic'] = 48.0, ['Kennen'] = 55.0, ['Nunu'] = 65, ['Ryze'] = 65,
		['Zed'] = 65, ['Nautilus'] = 80.0, ['Gangplank'] = 65, ['shopevo'] = 65, ['Lux'] = 65, ['Sejuani'] = 80.0, ['Ezreal'] = 65,
		['OdinNeutralGuardian'] = 65, ['Khazix'] = 65, ['Sion'] = 80.0, ['Aatrox'] = 65, ['Hecarim'] = 80.0, ['Pantheon'] = 65,
		['Shyvana'] = 50.0, ['Zyra'] = 65, ['Karthus'] = 65, ['Rammus'] = 65, ['Zilean'] = 65, ['Chogath'] = 80.0, ['Malzahar'] = 65, 
		['YorickRavenousGhoul'] = 1.0, ['YorickSpectralGhoul'] = 1.0, ['JinxMine'] = 65, ['YorickDecayedGhoul'] = 1.0,
		['XerathArcaneBarrageLauncher'] = 65, ['Odin_SOG_Order_Crystal'] = 65, ['TestCube'] = 65, ['ShyvanaDragon'] = 80.0, 
		['FizzBait'] = 65, ['ShopKeeper'] = 65, ['Blue_Minion_MechMelee'] = 65.0, ['OdinQuestBuff'] = 65, ['TT_Buffplat_L'] = 65,
		['TT_Buffplat_R'] = 65, ['KogMawDead'] = 65, ['TempMovableChar'] = 48.0, ['Lizard'] = 50.0, ['GolemOdin'] = 80.0, 
		['OdinOpeningBarrier'] = 65, ['TT_ChaosTurret4'] = 88.4, ['TT_Flytrap_A'] = 65, ['TT_Chains_Order_Periph'] = 65,
		['TT_NWolf'] = 65.0, ['ShopMale'] = 65, ['OdinShieldRelic'] = 65, ['TT_Chains_Xaos_Base'] = 65, ['LuluSquill'] = 50.0,
		['TT_Shopkeeper'] = 65, ['redDragon'] = 100.0, ['MonkeyKingClone'] = 65, ['Odin_skeleton'] = 65, ['OdinChaosTurretShrine'] = 88.4, 
		['Cassiopeia_Death'] = 65, ['OdinCenterRelic'] = 48.0, ['Ezreal_cyber_1'] = 65, ['Ezreal_cyber_3'] = 65, ['Ezreal_cyber_2'] = 65,
		['OdinRedSuperminion'] = 55.0, ['TT_Speedshrine_Gears'] = 65, ['JarvanIVWall'] = 65, ['DestroyedNexus'] = 65, ['ARAMOrderNexus'] = 65,
		['Red_Minion_MechCannon'] = 65.0, ['OdinBlueSuperminion'] = 55.0, ['SyndraOrbs'] = 65, ['LuluKitty'] = 50.0,
		['SwainNoBird'] = 65, ['LuluLadybug'] = 50.0, ['CaitlynTrap'] = 65, ['TT_Shroom_A'] = 65, ['ARAMChaosTurretShrine'] = 88.4, 
		['Odin_Windmill_Propellers'] = 65, ['DestroyedInhibitor'] = 65, ['TT_NWolf2'] = 50.0, ['OdinMinionGraveyardPortal'] = 1.0, 
		['SwainBeam'] = 65, ['Summoner_Rider_Order'] = 65.0, ['TT_Relic'] = 65, ['odin_lifts_crystal'] = 65, ['OdinOrderTurretShrine'] = 88.4, 
		['SpellBook1'] = 65, ['Blue_Minion_MechCannon'] = 65.0, ['TT_ChaosInhibitor_D'] = 65, ['Odin_SoG_Chaos'] = 65, ['TrundleWall'] = 65,
		['HA_AP_HealthRelic'] = 65, ['OrderTurretShrine'] = 88.4, ['OriannaBall'] = 48.0, ['ChaosTurretShrine'] = 88.4, ['LuluCupcake'] = 50.0, 
		['HA_AP_ChaosTurretShrine'] = 88.4, ['TT_Chains_Bot_Lane'] = 65, ['TT_NWraith2'] = 50.0, ['TT_Tree_A'] = 65, ['SummonerBeacon'] = 65, 
		['Odin_Drill'] = 65, ['TT_NGolem'] = 80.0, ['Shop'] = 65, ['AramSpeedShrine'] = 65, ['DestroyedTower'] = 65, ['OriannaNoBall'] = 65,
		['Odin_Minecart'] = 65, ['Summoner_Rider_Chaos'] = 65.0, ['OdinSpeedShrine'] = 65, ['TT_Brazier'] = 65, ['TT_SpeedShrine'] = 65,
		['odin_lifts_buckets'] = 65, ['OdinRockSaw'] = 65, ['OdinMinionSpawnPortal'] = 1.0, ['SyndraSphere'] = 48.0, ['TT_Nexus_Gears'] = 65,
		['Red_Minion_MechMelee'] = 65.0, ['SwainRaven'] = 65, ['crystal_platform'] = 65, ['MaokaiSproutling'] = 48.0, ['Urf'] = 65,
		['TestCubeRender10Vision'] = 65, ['MalzaharVoidling'] = 10.0, ['GhostWard'] = 1, ['MonkeyKingFlying'] = 65, ['LuluPig'] = 50.0,
		['AniviaIceBlock'] = 65, ['TT_OrderInhibitor_D'] = 65, ['yonkey'] = 65, ['Odin_SoG_Order'] = 65, ['RammusDBC'] = 65, ['FizzShark'] = 65,
		['LuluDragon'] = 50.0, ['OdinTestCubeRender'] = 65, ['OdinCrane'] = 65, ['TT_Tree1'] = 65, ['ARAMOrderTurretShrine'] = 88.4,
		['TT_Chains_Order_Base'] = 65, ['Odin_Windmill_Gears'] = 65, ['ARAMChaosNexus'] = 65, ['TT_NWraith'] = 50.0, ['TT_OrderTurret4'] = 88.4,
		['Odin_SOG_Chaos_Crystal'] = 65, ['TT_SpiderLayer_Web'] = 65, ['OdinQuestIndicator'] = 1.0, ['JarvanIVStandard'] = 65, ['TT_DummyPusher'] = 65,
		['OdinClaw'] = 65, ['EliseSpiderling'] = 1.0, ['QuinnValor'] = 65, ['UdyrTigerUlt'] = 65, ['UdyrTurtleUlt'] = 65, ['UdyrUlt'] = 65,
		['UdyrPhoenixUlt'] = 65, ['ShacoBox'] = 10, ['HA_AP_Poro'] = 65, ['AnnieTibbers'] = 80.0, ['UdyrPhoenix'] = 65, ['UdyrTurtle'] = 65, 
		['UdyrTiger'] = 65, ['HA_AP_OrderShrineTurret'] = 88.4, ['HA_AP_OrderTurretRubble'] = 65, ['HA_AP_Chains_Long'] = 65,
		['HA_AP_OrderCloth'] = 65, ['HA_AP_PeriphBridge'] = 65, ['HA_AP_BridgeLaneStatue'] = 65, ['HA_AP_ChaosTurretRubble'] = 88.4, 
		['HA_AP_BannerMidBridge'] = 65, ['HA_AP_PoroSpawner'] = 50.0, ['HA_AP_Cutaway'] = 65, ['HA_AP_Chains'] = 65, ['HA_AP_ShpSouth'] = 65,
		['HA_AP_HeroTower'] = 65, ['HA_AP_ShpNorth'] = 65, ['ChaosInhibitor_D'] = 65, ['ZacRebirthBloblet'] = 65, ['OrderInhibitor_D'] = 65,
		['Nidalee_Spear'] = 65, ['Nidalee_Cougar'] = 65, ['TT_Buffplat_Chain'] = 65, ['WriggleLantern'] = 1, ['TwistedLizardElder'] = 65.0,
		['RabidWolf'] = 65.0, ['HeimerTGreen'] = 50.0, ['HeimerTRed'] = 50.0, ['ViktorFF'] = 65, ['TwistedGolem'] = 80.0, ['TwistedSmallWolf'] = 50.0, 
		['TwistedGiantWolf'] = 65.0, ['TwistedTinyWraith'] = 50.0, ['TwistedBlueWraith'] = 50.0, ['TwistedYoungLizard'] = 50.0, ['Red_Minion_Melee'] = 48.0,
		['Blue_Minion_Melee'] = 48.0, ['Blue_Minion_Healer'] = 48.0, ['Ghast'] = 60.0, ['blueDragon'] = 100.0, ['Red_Minion_MechRange'] = 65.0,
		['Test_CubeSphere'] = 65,
		}
	...
	if not _G.VPredictionMenu then
		_G.VPredictionMenu = MenuConfig("VPrediction", "VPrediction")			
			_G.VPredictionMenu:DropDown("Mode", "Cast Mode", 1, {"Fast", "Medium", "Slow" })			
		--[[Collision]]
		_G.VPredictionMenu:Menu("Collision", "Collision")
			_G.VPredictionMenu.Collision:Slider("Buffer", "Collision buffer", 20, 0, 100)
			_G.VPredictionMenu.Collision:Boolean("Minions", "Normal minions", true)
			_G.VPredictionMenu.Collision:Boolean("Mobs", "Jungle minions", true)
			_G.VPredictionMenu.Collision:Boolean("Others", "Others", true)
			_G.VPredictionMenu.Collision:Boolean("CHealth", "Check if minions are about to die (BETA)", false)
			_G.VPredictionMenu.Collision.CHealth:Note("^ Can cause fps drops")
			_G.VPredictionMenu.Collision:Boolean("UnitPos", "Check collision at the unit pos", true)
			_G.VPredictionMenu.Collision:Boolean("CastPos", "Check collision at the cast pos", true)
			_G.VPredictionMenu.Collision:Boolean("PredictPos", "Check collision at the predicted pos", false)
		if self.showdevmode then
		_G.VPredictionMenu:addSubMenu("Developers", "Developers")
			_G.VPredictionMenu.Developers:Boolean("Debug", "Enable debug", false)
			_G.VPredictionMenu.Developers:Boolean("SC", "Show collision", false)
		end
	end
	--[[Use waypoints from the last 10 seconds]]
	self.WaypointsTime = 10	
	self.EnemyMinions 	= enemyCreeps(2000)
	self.JungleMinions 	= getJungleMinions(2000)
	self.OtherMinions 	= allyCreeps(2000)
	self.TargetsVisible = {}
	...
	-- VIP Module Fucking PathFinder!		
	-- Callback.Bind('Tick', function(NetworkID) self:OnNewWayPoints(NetworkID) end)
	-- Callback.Bind('OnGainVision', function(unit) self:OnGainVision(unit) end)
	...
	Callback.Bind('ProcessSpell', function(unit, spell) self:CollisionProcessSpell(unit, spell) end)
	self.BlackList = 
	{
...
function VPrediction:OnDash(unit, dash)
	if unit.type == myHero.type then
		...
		dash.startT = self:GetTime() - Game.Latency()/2000
...
function VPrediction:OnProcessSpell(unit, spell)
	if unit and unit.type == myHero.type then
		...
		for i, s in ipairs(self.blinks) do
			local LandingPos = GetDistance(unit, Geometry.Vector3(spell.endPos.x, spell.endPos.y, spell.endPos.z)) < s.range and Geometry.Vector3(spell.endPos.x, spell.endPos.y, spell.endPos.z) 
			or Geometry.Vector3(unit.x, unit.y, unit.z) + s.range * (Geometry.Vector3(spell.endPos.x, spell.endPos.y, spell.endPos.z) - Geometry.Vector3(unit.x, unit.y, unit.z)):Normalize()
			if spell.name:lower() == s.name and not Game.IsWall(Geometry.Vector3(spell.endPos.x, spell.endPos.y, spell.endPos.z)) then -- Game.IsWall(Geometry.Vector3(afterKnock.x, myHero.y, afterKnock.y))
				self.TargetsDashing[unit.networkID] = {isblink = true, duration = s.delay, endT = self:GetTime() + s.delay, endT2 = self:GetTime() + s.delay2, startPos = Geometry.Vector3(unit.x, unit.y, unit.z), endPos = LandingPos}
				return 
			end
		end
...
function VPrediction:OnNewWayPoints(NetworkID)
	for i = 0, Game.ObjectCount() do	
		...
		if object and object.valid and not object.dead and (object.team == 100 or object.team == 200 or object.team == 300) and object ~= "boolean" then
			if object and object.valid and object.networkID and object.type == myHero.type then
				...
				local WaypointsToAdd = NavigationPath:curPath(object)
				if WaypointsToAdd and #WaypointsToAdd >= 1 then
					--[[Save only the last waypoint (where the player clicked)]]
					table.insert(self.TargetsWaypoints[NetworkID], {unitpos = GVector3(object) , waypoint = WaypointsToAdd[#WaypointsToAdd], time = self:GetTime(), n = #WaypointsToAdd})
				end
			elseif object and object.valid and object.type ~= myHero.type then
				local i = 1
				while i <= #self.ActiveAttacks do
					if (self.ActiveAttacks[i].Attacker and self.ActiveAttacks[i].Attacker.valid and self.ActiveAttacks[i].Attacker.networkID == NetworkID and (self.ActiveAttacks[i].starttime + self.ActiveAttacks[i].windUpTime - Game.Latency()/2000) > self:GetTime()) then
						local wpts = NavigationPath:curPath(object)
						if #wpts > 1 then
...
function VPrediction:IsImmobile(unit, delay, radius, speed, from, spelltype)
	if self.TargetsImmobile[unit.networkID] then
		...
		if (self.TargetsImmobile[unit.networkID] > (self:GetTime() + delay + ExtraDelay) and spelltype == "circular") then
			return true, GVector3(unit), GVector3(unit) + (radius/3) * (GVector3(from) - GVector3(unit)):Normalize()
		elseif (self.TargetsImmobile[unit.networkID] + (radius / unit.ms)) > (self:GetTime() + delay + ExtraDelay) then
			return true, GVector3(unit), GVector3(unit)
		end
	end
	return false, GVector3(unit), GVector3(unit)
end
	...
	if self.TargetsDashing[unit.networkID] then
		...
		if dash.endT >= self:GetTime() then
			...
			if dash.isblink then
				...
				-- dash.startPos = {x=dash.startPos.x, 0,dash.startPos.z}
				-- dash.endPos = {x=dash.endPos.x, 0,dash.endPos.z}
				-- print(dash.startPos.x)
				-- print(dash.endPos.x)
				-- print(from.x)
				...
				if t then
					Position = t==t1 and Geometry.Vector3(p1.x, 0, p1.y) or Vector(p2.x, 0, p2.y)
					CanHit = true
				else
					Position = Geometry.Vector3(dash.endPos.x, 0, dash.endPos.z)
	...
	if distance > 0 then
		for i = 1, #Waypoints -1 do
			...
			if dist >= remaining then
				result[1] = GVector3(A) + remaining * (GVector3(B) - GVector3(A)):Normalize()
		...
		result = Waypoints
		result[1] = GVector3(A) - distance * (GVector3(B) - GVector3(A)):Normalize()
	end
	return result
end
function VPrediction:GetCurrentWayPoints(object)
	...
	-- if not VIP_USER then
		-- if object.hasMovePath then
			-- table.insert(result, Geometry.Vector3(object.x, object.z))
			-- for i = object.pathIndex, object.pathCount do
				-- path = object:GetPath(i)
				-- table.insert(result, Geometry.Vector3(path.x, path.z))
			-- end
		-- else
			-- table.insert(result, object and Geometry.Vector3(object.x, object.z) or Geometry.Vector3(object.x, object.z))
		-- end
		-- return result
	-- else
		-- local wayPoints, lineSegment, distanceSqr, fPoint = GetRawWayPoints(object), 0, math.huge, nil
		local way, lineSegment, distanceSqr, fPoint = object.hasMovePath, 0, math.huge, nil
		if (not way and not object) or (not way and object) or (object.path.count < 2) then return { { x = object.x, y = object.z }} end
		for i = 1, object.path.count -1 do
			-- local wayPoints = object:GetPath(i)
			-- print(object.path:Path(i))
			local p1, tmp1, tmp2 = VectorPointProjectionOnLineSegment(object.path:Path(i), object.path:Path(i + 1), GVector3(object))
			-- print("p2"..object.x)
			-- print("p1"..tostring(p1.x))
			local distanceSegmentSqr = GetDistanceSqr(p1, object, "1")
		...
		for i = lineSegment + 1, object.path.count do
			result[#result + 1] = object.path:Path(i)
		end
			-- print("Vperror"..result[1])
			-- print("Vperror"..result[2])
		if #result == 2 and GetDistanceSqr(result[1], result[2], "2") < 400 then result[2] = nil end
		return result
	-- end
end
...
function VPrediction:CalculateTargetPosition(unit, delay, radius, speed, from, spelltype)
	local Waypoints = {}
	local Position, CastPosition = GVector3(unit), GVector3(unit)
	local t
		...
		if speed ~= math.huge then
			for i = 1, #Waypoints - 1 do
				...
				if i == #Waypoints - 1 then
					B = GVector3(B) + radius * GVector3(B - A):Normalize()
				end
				-- print(A.x)
				-- print(B.x)
				-- print(from.x)		
				local t1, p1, t2, p2, D = VectorMovementCollision(A, B, unit.ms, from, speed)
...
function VPrediction:MaxAngle(unit, currentwaypoint, from)
	...
	local Max = 0
	local CV = (Geometry.Vector3(currentwaypoint.x, 0, currentwaypoint.y) - GVector3(unit))
		for i, waypoint in ipairs(WPtable) do
				local angle = Geometry.Vector3(0, 0, 0):angleBetween(CV, Geometry.Vector3(waypoint.waypoint.x, 0, waypoint.waypoint.y) - Geometry.Vector3(waypoint.unitpos.x, 0, waypoint.unitpos.y))
				if angle > Max then
					Max = angle
				end
		end
...
function VPrediction:WayPointAnalysis(unit, delay, radius, range, speed, from, spelltype)
	...
	local N = (_G.VPredictionMenu.Mode:Value() == _SLOW) and 3 or 2
	local t1 = (_G.VPredictionMenu.Mode:Value() == _SLOW) and 1 or 0.5
	...
	N = (_G.VPredictionMenu.Mode:Value() == _SLOW) and 2 or 1
	if self:CountWaypoints(unit.networkID, self:GetTime() - N) == 0 then
		HitChance = 2
	end
	if _G.VPredictionMenu.Mode:Value() == _FAST then
		HitChance = 2
	end
	...
	if Position and CastPosition and ((radius / unit.ms >= delay + GetDistance(from, CastPosition)/speed) or (radius / unit.ms >= delay + GetDistance(from, Position)/speed)) then
		...
		--[[Angle too wide]]
	if math.atan2((CastPosition.x - unit.x), (CastPosition.z - unit.z)) > 60 then
		HitChance = 1
	end
...
function VPrediction:GetBestCastPosition(unit, delay, radius, range, speed, from, collision, spelltype)
	...
	from = from and from or GVector3(myHero)
	if from.networkID and from.networkID == myHero.networkID then
		from = GVector3(myHero)
	end
	-- print("AA2"..from)
	-- print("Vperror"..from)
	local IsFromMyHero = GetDistanceSqr(from, myHero,"3") < 50*50 and true or false
	delay = delay + (0.07 + Game.Latency()/ 2000)
	local Position, CastPosition, HitChance = GVector3(unit), GVector3(unit), 0
	...
	if unit.type ~= myHero.type then
		...
		if self.DontShoot[unit.networkID] and self.DontShoot[unit.networkID] > self:GetTime() then
			Position, CastPosition = Geometry.Vector3(unit.x, unit.y, unit.z),  Geometry.Vector3(unit.x, unit.y, unit.z)
			HitChance = 0
	...
	if IsFromMyHero then
		-- print("Vperror"..from)
		-- print("Vperror"..Position)
		if (spelltype == "line" and GetDistanceSqr(from, Position,"4") >= range * range) then
			HitChance = 0
		end
		if (spelltype == "circular" and (GetDistanceSqr(from, Position,"5") >= (range + radius)^2)) then
			HitChance = 0
		end
		-- print("Vperror"..from)
		-- print("Vperror"..CastPosition)
		if self.ShotAtMaxRange and HitChance ~= 0 and spelltype == "circular" and (GetDistanceSqr(from, CastPosition,"6") > range ^ 2) then
			if GetDistanceSqr(from, Position,"7") <= (range + radius / 1.4) ^ 2 then
				if GetDistanceSqr(from, Position,"8") <= range * range then
					CastPosition = Position
				else
					CastPosition = GVector3(from) + range * (GVector3(Position) - GVector3(from)):Normalize()
				end
			end
		elseif (GetDistanceSqr(from, CastPosition,"9") > range ^ 2) then
			HitChance = 0
		end
	end
	...
	if collision and HitChance > 0 then
		...
		if collision and _G.VPredictionMenu.Collision.UnitPos:Value() and self:CheckMinionCollision(unit, unit, delay, radius, range, speed, from) then
			HitChance = -1
		elseif _G.VPredictionMenu.Collision.PredictPos:Value() and self:CheckMinionCollision(unit, Position, delay, radius, range, speed, from) then
			HitChance = -1
		elseif _G.VPredictionMenu.Collision.CastPos:Value() and self:CheckMinionCollision(unit, CastPosition, delay, radius, range, speed, from) then
			HitChance = -1
		end
	end
	return CastPosition, HitChance, Position
...
function VPrediction:CollisionProcessSpell(unit, spell)
	if unit and unit.valid and spell.target and unit.type ~= myHero.type and spell.target.type == 'obj_AI_Minion' and unit.team == myHero.team and spell and spell.name and (spell.name:lower():find("attack") or (spell.name == "frostarrow")) and spell.windUpTime and spell.target then
		if GetDistanceSqr(unit) < 4000000 then
			local time = self:GetTime() + spell.windUpTime + GetDistance(spell.target, unit) / self:GetProjectileSpeed(unit) -- Game.Latency()/2000
			local i = 1
			while i <= #self.ActiveAttacks do
			...
			table.insert(self.ActiveAttacks, {Attacker = unit, pos = Geometry.Vector3(unit.x, unit.y, unit.z), Target = spell.target, animationTime = spell.animationTime, damage = self:CalcDamageOfAttack(unit, spell.target, spell, 0), hittime=time, starttime = self:GetTime() - Game.Latency()/2000, windUpTime = spell.windUpTime, projectilespeed = self:GetProjectileSpeed(unit)})
		end
	end
end
function VPrediction:CheckCol(unit, minion, Position, delay, radius, range, speed, from, draw)
	...
	if minion.type ~= myHero.type and _G.VPredictionMenu.Collision.CHealth:Value() and self:GetPredictedHealth(minion,  delay  + GetDistance(from, minion) / speed - Game.Latency()/1000) < 0 then
		return false
	end
	local waypoints = self:GetCurrentWayPoints(minion)
	local MPos, CastPosition = #waypoints == 1 and GVector3(minion) or self:CalculateTargetPosition(minion, delay, radius, speed, from, "line")
	-- print("Vperror"..from)
	-- print("Vperror"..MPos)
	if GetDistanceSqr(from, MPos,"10") <= (range)^2 and GetDistanceSqr(from, minion,"11") <= (range + 100)^2 then
		local buffer = (#waypoints > 1) and _G.VPredictionMenu.Collision.Buffer:Value() or 8
		if minion.type == myHero.type then
			buffer = buffer + self:GetHitBox(minion)
		end
		if draw then
			DrawCircle3D(minion.x, myHero.y, minion.z, self:GetHitBox(minion) + buffer, 1, Graphics.ARGB(255, 255, 255, 255))
			DrawCircle3D(MPos.x, myHero.y, MPos.z, self:GetHitBox(minion) + buffer, 1, Graphics.ARGB(255, 255, 255, 255))
			self:DLine(MPos, minion, Color)
		end
		if #waypoints > 1 then
			local proj1, pointLine, isOnSegment = VectorPointProjectionOnLineSegment(from, Position, GVector3(MPos))
	-- print("Vperror"..proj1)
	-- print("Vperror"..MPos)
			if isOnSegment and (GetDistanceSqr(MPos, proj1,"12") <= (self:GetHitBox(minion) + radius + buffer) ^ 2) then
				return true
			end
		end
		local proj2, pointLine, isOnSegment = VectorPointProjectionOnLineSegment(from, Position, GVector3(minion))
	-- print("Vperror"..proj2)
	-- print("Vperror"..minion)
		if isOnSegment and (GetDistanceSqr(minion, proj2,"13") <= (self:GetHitBox(minion) + radius + buffer) ^ 2) then
			return true
		end
	end
	return false
...
function VPrediction:CheckMinionCollision(unit, Position, delay, radius, range, speed, from, draw, updatemanagers)
	Position = GVector3(Position)
	from = from and GVector3(from) or myHero
	...
	local result = false
	if _G.VPredictionMenu.Collision.Minions:Value() then
	...
	if _G.VPredictionMenu.Collision.Mobs:Value() then
	...
	if _G.VPredictionMenu.Collision.Others:Value() then
	...
	if draw then
		local Direction = GVector3(Position - from):perpendicular():Normalize()
		local Color = result and Graphics.ARGB(255, 255, 0, 0) or Graphics.ARGB(255, 0, 255, 0)
		local P1r = GVector3(from) + radius * GVector3(Direction)
		local P1l = GVector3(from) - radius * GVector3(Direction)
		local P2r = GVector3(from) + radius * Direction - GVector3(Direction):perpendicular() * GetDistance(from, Position)
		local P2l = GVector3(from) - radius * Direction - GVector3(Direction):perpendicular() * GetDistance(from, Position)
		...
		if not result and IsKeyDown(string.byte("T")) then
			myHero:CastSpell(_Q, Position.x, Position.z)
		end
	end
	return false
end
...
function VPrediction:GetCircularAOECastPosition(unit, delay, radius, range, speed, from, collision)
	...
	while #points > 1 do
		...
		for i=2, #points do
		-- print("Vperror"..points[i])
		-- print("Vperror"..points[1])
			local d = GetDistanceSqr(points[i], points[1],"14")
...
function VPrediction:GetLineAOECastPosition(unit, delay, radius, range, speed, from)
	...
	radius = radius == 0 and 1 or (radius + self:GetHitBox(unit)) - 4
	from = from and GVector3(from) or GVector3(myHero)
	local function CircleCircleIntersection(C1, C2, R1, R2)
		local D = GetDistance(C1, C2)
		local A = (R1 * R1 - R2 * R2 + D * D ) / (2 * D)
		local H = math.sqrt(R1 * R1 - A * A);
		local Direction = (GVector3(C2) - GVector3(C1)):Normalize()
		local PA = GVector3(C1) + A * Direction
	...
	local function GetPosiblePoints(from, pos, width, range)
		...
		local V1 = (P1 - from)
		local V2 = (P2 - from)
		return from + range * (pos - V1 - from):Normalize(), from + range * (pos - V2 - from):Normalize()
	end
	local function CountHits(P1, P2, width, points)
		...
		for i, point in ipairs(points) do
			...
			if isOnSegment and GetDistanceSqr(pointSegment, point,"15") <= width * width then
				hits = hits + 1
	...
	if MaxHit > 1 then
		...
		for i, hitp in ipairs(MaxHitPoints) do
			for o, hitp2 in ipairs(MaxHitPoints) do
				local StartP, EndP = GVector3(from), (GVector3(hitp) + GVector3(hitp2)) / 2
	...
	-- print("Vperror"..hitp)
	-- print("Vperror"..pointLine)
	-- print("Vperror"..pointLine2)
				local dist = GetDistanceSqr(hitp, pointLine,"16") + GetDistanceSqr(hitp2, pointLine2,"17")
		...
		if self.ReturnHitTable then
			for i = #Positions, 1, -1 do
				local pointSegment, pointLine, isOnSegment = VectorPointProjectionOnLineSegment(GVector3(from), (p1 + p2) / 2, Positions[i].Position)
	-- print("Vperror"..pointLine)
	-- print("Vperror"..Positions[i].Position)
				if (not isOnSegment) or (GetDistanceSqr(pointLine, Positions[i].Position,"18") > (radius + 5)^2) then
...
function VPrediction:GetConeAOECastPosition(unit, delay, angle, range, speed, from)
	...
	local points = {}
	local mainCastPosition, mainHitChance = CastPosition, HitChance
	table.insert(points, GVector3(Position) - GVector3(from))
	local function CountVectorsBetween(V1, V2, points)
		local result = 0	
		local hitpoints = {} 
		for i, test in ipairs(points) do
			local NVector = GVector3(V1):Cross(test)
			local NVector2 = GVector3(test):Cross(V2)
	...
	local function CheckHit(position, angle, points)
		local direction = GVector3(position):Normalize()
		local v1s = Geometry.Vector2(position.x, position.z):Rotate(-angle)
		local v2s = Geometry.Vector2(position.x, position.z):Rotate(angle/2)
		local v1 = Geometry.Vector3(v1s.x, 0, v1s.y)
		local v2 = Geometry.Vector3(v2s.x, 0, v2s.y)
		return CountVectorsBetween(v1, v2, points)
	end
	for i = 1, Game.HeroCount(), 1 do
    local target = Game.Hero(i)
		if target.networkID ~= unit.networkID and ValidTarget(target, range * 1.5, TEAM_ENEMY) then
			CastPosition, HitChance, Position = self:GetBestCastPosition(target, delay, radius, range, speed, from, false, "line")
			-- print("Vperror"..from)
			-- print("Vperror"..Position)
			if GetDistanceSqr(from, Position,"19") < range * range then
				table.insert(points, GVector3(Position) - GVector3(from))
			end
		end
	end
	...
	if #points > 1 then
		for i, point in ipairs(points) do
			local v1s = Geometry.Vector2(point.x, point.z):Rotate(angle/2)
			local v2s = Geometry.Vector2(point.x, point.z):Rotate(-angle/2)
			local pos1 = Geometry.Vector3(v1s.x, 0, v1s.y)
			local pos2 = Geometry.Vector3(v2s.x, 0, v2s.y)
	...
	if MaxHit > 1 then
		...
		for i, hitp in ipairs(MaxHitPoints) do
			for o, hitp2 in ipairs(MaxHitPoints) do
				local cangle = math.atan2((hitp.x - hitp2.x), (hitp.z - hitp2.z))
		...
		-- print("B "..from)
		return GVector3(from) + range * (((p1 + p2) / 2)):Normalize(), mainHitChance, MaxHit
	else
		-- print("C "..mainCastPosition)
	...
	if self.lastick == nil or self:GetTime() - self.lastick > 0.2 then
		...
		for i = 1, Game.HeroCount(), 1 do
			...
			for j = 1, unit.buffCount do
				...
				-- if buff.valid then print(buff) end
				if buff.valid and buff.name == "Stun" and buff.startT <= Game.ServerTimer() and buff.endT >= Game.ServerTimer()  then --
...
function VPrediction:DrawSavedWaypoints(object, time)
	...
	for i, waypoint in ipairs(Waypoints) do
		DrawCircle3D(waypoint.waypoint.x, myHero.y, waypoint.waypoint.y, 100, 2, Graphics.ARGB(255, 255, 255, 255))
		DrawText3D(tostring(i), waypoint.waypoint.x, myHero.y, waypoint.waypoint.y, 13, Graphics.ARGB(255, 255, 255, 255), true)
		DrawCircle3D(waypoint.unitpos.x, myHero.y, waypoint.unitpos.y, 100, 2, Graphics.ARGB(255, 255, 0, 0))
	end
end
function VPrediction:DrawHitBox(object)
	DrawCircle3D(object.x, object.y, object.z, self:GetHitBox(object), 1, Graphics.ARGB(255, 255, 255, 255))
	if object then
		DrawCircle3D(object.x, object.y, object.z, self:GetHitBox(object), 1, Graphics.ARGB(255, 0, 255, 0))
	end
end
...
function VPrediction:OnDraw()
	if self.showdevmode and _G.VPredictionMenu.Developers.Debug:Value() then
		...
		if _G.VPredictionMenu.Developers.SC:Value() then
			self.EnemyMinions:update()
			self.JungleMinions:update()
			self.OtherMinions:update()
			self:CheckMinionCollision(GVector3(myHero) + 1050 * (GVector3(mousePos) - GVector3(myHero)):Normalize(), 0.25, 70, 1050, 1800, myHero, true)
		end
		if target then
			self:DrawHitBox(target) 
			local CastPosition,  HitChance,  Position = self:GetCircularCastPosition(target, 0.6, 70, 900, math.huge)
			if HitChance >= -1 then
				DrawText3D(tostring(HitChance), CastPosition.x, myHero.y, CastPosition.z, 40, Graphics.ARGB(255, 255, 255, 255), true)
				DrawCircle3D(Position.x, myHero.y, Position.z, 70 + self:GetHitBox(target), 1, Graphics.ARGB(255, 0, 255, 0))
				DrawCircle3D(CastPosition.x, myHero.y, CastPosition.z, 70 + self:GetHitBox(target), 1, Graphics.ARGB(255, 255, 0, 0))
			end
			local waypoint = self:GetCurrentWayPoints(target)
			for i  = 1, #waypoint-1 do
				self:DLine(Geometry.Vector3(waypoint[i].x, myHero.y, waypoint[i].y), Geometry.Vector3(waypoint[i+1].x, myHero.y, waypoint[i+1].y), Graphics.ARGB(255,255,255,255))
			end
		end
	end
end
...
function VPrediction:CalcDamageOfAttack(source, target, spell, additionalDamage)
	...
	if source.type == "obj_AI_Minion" and target.type == myHero.type and source.team ~= 300 then
